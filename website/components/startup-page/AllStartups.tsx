...
const AllStartups: FunctionComponent<Props> = ({ searchText, startups }) => {
  ...
  const [filter, setFilter] = useState<(FormType& { websitePhoto: string ,image:string})[]>([])
  ...
  return (
    <div className={"mt-6"}>
      ...
      />
      <div
        className="grid gap-3 grid-cols-1 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2"
